    ...
    public class TokenFactoryService : ITokenFactoryService
    {
        ...
        public async Task<JwtTokensData> CreateJwtTokensAsync(User user)
        {
            ...
            return new JwtTokensData
            {
                ...
                Claims = claims,
                AccessTokenExpirationMinutes= _configuration.Value.AccessTokenExpirationMinutes,
                RefreshTokenExpirationMinutes= _configuration.Value.RefreshTokenExpirationMinutes
        ...
        private async Task<(string AccessToken, IEnumerable<Claim> Claims)> createAccessTokenAsync(User user)
        {
            ...
            {
                claims.Add(new Claim(ClaimTypes.Role, role.ToString(), ClaimValueTypes.String, _configuration.Value.Issuer));
            }
